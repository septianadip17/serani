  ...
  return (
    <div>
      ...
      <div className="flowers">
        ...
        {/* Grass & Grow elements */}
        {/* ... semua grow-ans dan flower__grass tetap bisa ditulis sama persis, hanya className */}
      </div>

      {/* Audio */}
      <audio id="myAudio" autoPlay loop>
        <source src="/public/music/bg-music.mp3" type="audio/mp3" />
